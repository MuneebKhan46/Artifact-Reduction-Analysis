...
print(f"Total Training Dataset Original and Denoised: {len(train_orig), len(train_denoised)}")
print(f"Total Validation Dataset Original and Denoised: {len(val_orig), len(val_denoised)}")
